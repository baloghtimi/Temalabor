...
/**
 * This is the item provider adapter for a {@link FreshmanCamp.freshmanCamp.Participant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParticipantItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 FreshmanCampPackage.Literals.PARTICIPANT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Participant_color_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Participant_color_feature", "_UI_Participant_type"),
				 FreshmanCampPackage.Literals.PARTICIPANT__COLOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Participant.class)) {
			case FreshmanCampPackage.PARTICIPANT__NAME:
			case FreshmanCampPackage.PARTICIPANT__COLOR:

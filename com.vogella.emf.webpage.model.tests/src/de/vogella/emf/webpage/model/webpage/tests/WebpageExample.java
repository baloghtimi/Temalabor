...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>webpage</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class WebpageExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.webpage"));
				Web root = WebpageFactory.eINSTANCE.createWeb();
